  ...
  return (
    <div className={btn ? "dark" : "light"}>
      <div className="w-full min-h-screen bg-gradient-custom">
        <button
          onClick={btnHandle}
          className="font-bold rounded text-xs lg:w-32 h-10 sm:w-28 absolute top-3 right-3 bg-background-Color text-text-Color"
        >
          {btn === true ? (
        ...
        <div className="flex flex-col justify-center items-center text-center">
          <h1 className="lg:text-6xl md:text-4xl sm:text-4xl sm:pt-24 lg:pt-12 mx-8 text-text-Color">
            Weather App
          </h1>
          <input
